...
var todayDate = "10-09-2023";
var myName = "Muzammal Hussain";
var comment1 = "It's date of today " + todayDate;
var comment2 = "It's my name " + myName;
console.log(comment1);
console.log(comment2);
//console.log(comment1,todayDate)
//console.log(comment2,myName)
